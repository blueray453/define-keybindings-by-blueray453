...
export default class ExampleExtension extends Extension {
  enable() {
    ...
    this._bindings = {
      'kb-1': { accel: '<Super>grave', command: 'align_windows' },
      ...
      'kb-9': { accel: '<Super>m', command: 'toggle_mark_windows' },
      'kb-10': { accel: '<Super>w', command: 'rofi-windows-on-all-workspaces' },
      'kb-11': { accel: '<Super>Delete', command: 'close_other_windows' },
      'kb-12': { accel: '<Super>o', command: 'open-file-path' },
      'kb-13': { accel: '<Super>q', command: 'capture2text' },
      'kb-14': { accel: 'Print', command: 'rofi-screenshot' },
      'kb-15': { accel: '<Super>p', command: 'toggle_pin_windows' },
